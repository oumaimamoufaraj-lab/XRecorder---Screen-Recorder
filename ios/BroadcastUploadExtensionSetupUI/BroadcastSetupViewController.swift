...
class BroadcastSetupViewController: UIViewController {
  override func viewDidLoad() {
    ...
    messageLabel.text =
      "Tap Start Broadcast to begin full-screen recording with XRecorder."
  ...
  private func userDidFinishSetup() {
    let broadcastURL = URL(string: "https://xrecorder.local/broadcast")!
    let setupInfo: [String: NSCoding & NSObjectProtocol] = [
      "broadcastName": "XRecorder" as NSString,
    ]
