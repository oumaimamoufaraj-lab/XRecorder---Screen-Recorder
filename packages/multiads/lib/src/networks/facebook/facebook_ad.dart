...
class FacebookAD extends Ads {
    ...
    final widget = RepaintBoundary(
      child: ConstrainedBox(
        ...
        child: SizedBox(
          ...
          height: 50,
          child: LayoutBuilder(
            // ← add LayoutBuilder to get actual width
  ...
  VoidCallback? _interDismissCallback;

  @override
  void showInterstitialAd([VoidCallback? onDismissed]) {
    _interDismissCallback = onDismissed;
    if (!_interLoaded) {
      Log.log("Facebook >> Interstitial not ready");
      loadInterstitialAd();
      _interDismissCallback?.call();
      _interDismissCallback = null;
      return;
    }
